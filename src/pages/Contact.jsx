          ...
          <div className="relative px-6 pb-20 pt-14 sm:pt-22">
            <div className="mx-auto max-w-xl lg:max-w-md">
              ...
              <p className="mt-6 text-base font-light leading-8 text-gray-800">
                ...
                demande vous pouvez nous appeler, nous envoyer un email ou remplir ce
                formulaire et nous vous répondrons rapidement. Nous
                sommes impatients de vous accueillir chez nous.
              </p>
